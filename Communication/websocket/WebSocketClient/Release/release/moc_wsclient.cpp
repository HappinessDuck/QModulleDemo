...
QT_MOC_LITERAL(1, 9, 15), // "showTextSignals"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "text"
QT_MOC_LITERAL(4, 31, 15) // "showFileSignals"

    },
    "WSClient\0showTextSignals\0\0text\0"
    "showFileSignals"
};
...
void WSClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showTextSignals((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->showFileSignals((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WSClient::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WSClient::showTextSignals)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WSClient::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WSClient::showFileSignals)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WSClient::showTextSignals(const QString & _t1)
{
...
// SIGNAL 1
void WSClient::showFileSignals(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
